...
urlpatterns = [
    ...
    path("usuarios/listar", views.usuarios_creados, name="usuarios_creados"),
    path("usuarios/busqueda_avanzada", views.usuario_buscar_avanzado, name="usuario_buscar_avanzado"),
    ...
    path("partido/actualizar/<int:partido_id>", views.partido_editar, name="partido_editar"),
    ...
    path("recintos/crear", views.recinto_create, name="recinto_create"),
    path("recinto/buscar/", views.recinto_buscar, name="recinto_buscar"),
    path("recinto/busqueda_avanzada", views.recinto_buscar_avanzado, name="recinto_buscar_avanzado"),
    path("recinto/actualizar/<int:recinto_id>", views.recinto_editar, name="recinto_editar"),
