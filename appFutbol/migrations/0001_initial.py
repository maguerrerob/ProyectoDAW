# Generated by Django 3.2.22 on 2023-11-08 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campo_reservado', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='appFutbol.recinto')),
                ('creador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creador_reserva', to='appFutbol.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
